...
namespace xe
{
	...
	{
		xeSize decompress_size = ZSTD_getFrameContentSize(input, compress_data_size);
		...
		if (ZSTD_decompress(output, decompress_size, input, compress_data_size) != source_size)
		{
