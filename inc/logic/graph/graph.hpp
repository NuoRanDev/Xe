...
namespace xe
{
	...
	public:
		...
		{
			static_assert ((U != IMG_FORMAT::GRAY8 || U != IMG_FORMAT::GRAY16), "Can't match data");
	...
	using GraphBit8 = Graph<uint8_t, IMG_FORMAT::GRAY8>;

	using GraphBit16 = Graph<uint16_t, IMG_FORMAT::GRAY16>;
